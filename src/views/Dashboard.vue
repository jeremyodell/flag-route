...
const cards = [
  { name: 'Total Subscriptions', href: '#', icon: ScaleIcon, amount: '79' },
  { name: 'Subscribtions Expiring', href: '#', icon: ScaleIcon, amount: '3' },
  { name: 'Next Holiday', href: '#', icon: ScaleIcon, amount: 'July 4, 2021' },
  // More items...
];
const transactions = [
  {
